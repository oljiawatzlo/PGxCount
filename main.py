...
count_diplotype = CountDiplotype(output_path)
...
output_allele_path = 'report/pgx_count_haplotype.json'
with open(f'{output_allele_path}', 'w') as file:
...
output_dip_path = 'report/pgx_count_diplotype.json'
with open(f'{output_dip_path}', 'w') as file:
