...
result_hap = HaplotypeFormatter.format_diplotype(data_hap)
Utils.save_json(result_hap, 'report/pgx_count_haplotype.json')

data_dip = DiplotypeCounter.count_diplotype(master_data)
Utils.save_json(data_dip, '.out/count_haplotype/count_diplotype.json')    
result_dip = DiplotypeFormatter.format_diplotype(data_dip)
Utils.save_json(result_dip, 'report/pgx_count_diplotype.json')
